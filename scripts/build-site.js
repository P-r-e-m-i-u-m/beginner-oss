...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    :root{--bg:#0d1117;--surface:#161b22;--surface2:#1c2128;--border:#30363d;--text:#e6edf3;--text2:#9198a1;--text3:#656d76;--accent:#58a6ff;--green:#3fb950}
    ...
    .topbar-back{font-size:13px;color:var(--text2);display:flex;align-items:center;gap:6px}
    ...
    .benefit-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:14px;margin-bottom:32px}
    ...
    .criteria-item{background:var(--surface);border:1px solid var(--border);border-radius:10px;padding:14px 16px;display:flex;gap:14px;align-items:flex-start}
    .criteria-check{width:28px;height:28px;border-radius:50%;background:#23863620;border:1px solid #23863650;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0;margin-top:1px}
    ...
    .cta-box p{color:var(--text2);font-size:14px;margin-bottom:24px;max-width:420px;margin-left:auto;margin-right:auto}
    .cta-btn{display:inline-flex;align-items:center;gap:8px;background:#238636;color:#fff;font-weight:700;font-size:14px;padding:12px 24px;border-radius:8px;text-decoration:none;transition:background .15s}
    .cta-btn:hover{background:#2ea043;text-decoration:none}

    .steps-list{display:flex;flex-direction:column;gap:0}
    .step-row{display:flex;gap:16px;align-items:flex-start;padding:16px 0;border-bottom:1px solid var(--border)}
...
<div class="hero">
  ...
  <h1>Why add your repo<br>to beginner-oss?</h1>
  <p>Get your project in front of motivated beginners who are actively looking for their first contribution.</p>
</div>
...
<div class="content">
  ...
  <div class="section">
    <h2>What you get</h2>
    <p class="section-sub">Every listed repo gets real visibility with developers who are ready to contribute.</p>
    <div class="benefit-grid">
      <div class="benefit-card">
        <div class="benefit-icon">🎯</div>
        <h3>Targeted traffic</h3>
        <p>Visitors here are actively looking for their first PR. Not browsers — motivated contributors.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-icon">🔗</div>
        <h3>Direct issue links</h3>
        <p>Your good first issues show up as clickable links on your card. Zero friction for contributors.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-icon">🤖</div>
        <h3>Quality signal</h3>
        <p>The verified badge tells contributors your repo is genuinely welcoming — not just claiming to be.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-icon">🔄</div>
        <h3>Always fresh</h3>
        <p>Your listing auto-updates weekly. Issue counts refresh. Dead listings get removed automatically.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-icon">📊</div>
        <h3>Category placement</h3>
        <p>Listed under your tech category (Web Dev, AI/ML, DevOps etc) so the right people find you.</p>
      </div>
      <div class="benefit-card">
        <div class="benefit-icon">⚡</div>
        <h3>Zero maintenance</h3>
        <p>List once, stay listed. Bot re-validates every Monday. You don't have to do anything.</p>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <p class="section-sub">All 6 criteria are checked automatically. Fix any that fail and re-submit.</p>
    <div class="criteria-list">
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          <h4>README exists</h4>
          <p>Beginners need to understand what your project does before they can contribute. A README is the minimum bar.</p>
        </div>
      </div>
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          <h4>CONTRIBUTING.md exists</h4>
          <p>Tells contributors exactly how to fork, set up, and open a PR. Without it, beginners bounce.</p>
        </div>
      </div>
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          ...
          <p>Contributors need legal clarity. MIT, Apache, GPL — any recognized OSS license works.</p>
        </div>
      </div>
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          <h4>10+ contributors</h4>
          <p>Shows the repo has an active community. Single-maintainer repos are a risk for beginners whose PRs never get reviewed.</p>
        </div>
      </div>
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          <h4>Active in last 90 days</h4>
          <p>At least one commit in the past 90 days. Inactive repos mean unreviewed PRs — frustrating for first-timers.</p>
        </div>
      </div>
      <div class="criteria-item">
        <div class="criteria-check">✅</div>
        <div class="criteria-text">
          <h4>Open good first issues</h4>
          <p>At least one open issue tagged <code>good first issue</code>. This is where beginners start — if there are none, there's nothing to work on.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <p class="section-sub">Takes about 3 minutes. The bot handles the rest.</p>
    <div class="steps-list">
      <div class="step-row">
        <div class="step-num">1</div>
        <div class="step-content">
          <h4>Fork beginner-oss</h4>
          <p>Go to <a href="https://github.com/P-r-e-m-i-u-m/beginner-oss" target="_blank">github.com/P-r-e-m-i-u-m/beginner-oss</a> and click Fork.</p>
        </div>
      </div>
      <div class="step-row">
        <div class="step-num">2</div>
        <div class="step-content">
          <h4>Create a suggestion file</h4>
          <p>In the fork, create <code>suggestions/owner-reponame.md</code> with the repo URL and why it's beginner-friendly.</p>
        </div>
      </div>
      <div class="step-row">
        ...
        <div class="step-content">
          <h4>Open a PR</h4>
          <p>The bot validates within minutes. Pass = auto-merged and live on the site. Fail = closed with exact reasons so you know what to fix.</p>
        </div>
      </div>
      <div class="step-row">
        ...
        <div class="step-content">
          <h4>Done</h4>
          <p>Your repo is live. The site rebuilds automatically. The bot re-checks your listing every Monday to keep it fresh.</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="faq">
      <div class="faq-item">
        <h4>Can I suggest my own repo?</h4>
        <p>No. The bot auto-closes self-promotions. This keeps the directory trustworthy — listings are community-verified, not self-reported.</p>
      </div>
      <div class="faq-item">
        <h4>My repo doesn't have CONTRIBUTING.md. What do I do?</h4>
        <p>Create one. It doesn't have to be long — just explain how to fork, clone, run locally, and open a PR. Then ask a contributor or colleague to suggest it.</p>
      </div>
      <div class="faq-item">
        <h4>What if my listing gets removed?</h4>
        <p>The weekly bot removes repos that go 180+ days without a commit or get deleted. If your repo becomes active again, just suggest it again — it'll pass validation and get re-listed.</p>
      </div>
      <div class="faq-item">
        <h4>My repo has 8 contributors, not 10. Is there a workaround?</h4>
        <p>No workarounds — the criteria exist to protect beginners. Get 2 more people to contribute and then suggest it.</p>
      </div>
      <div class="faq-item">
        <h4>How long does the bot take?</h4>
        <p>Usually under 2 minutes from PR open to bot comment. If it passes, the site rebuilds and your repo is live within 5 minutes total.</p>
      </div>
    </div>
  </div>
  ...
  <div class="cta-box">
    ...
    <p>Ask someone who's used your repo to suggest it. Or suggest someone else's repo you think deserves more contributors.</p>
...
<footer>
  <p>Built by <a href="https://github.com/P-r-e-m-i-u-m" target="_blank">@P-r-e-m-i-u-m</a> · <a href="index.html">Back to directory</a> · <a href="https://github.com/P-r-e-m-i-u-m/beginner-oss" target="_blank">Source on GitHub</a></p>
</footer>
